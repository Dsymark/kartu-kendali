...
async function main() {
  ...
  console.log("Menanamkan data simulasi kartu kendali...");

  // 1. Mobil Honda CR-V (Sesuai cerita alur user: pernah Bapak Ahmad, lalu mutasi ke Bapak Budi nopol K 6 B)
